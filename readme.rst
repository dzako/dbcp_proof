...
`https://arxiv.org/abs/1703.01022
<https://arxiv.org/abs/1703.01022/>`_
...
-  *Existence of globally attracting fixed points of viscous Burgers
   ...
   `link
   <http://ww2.ii.uj.edu.pl/~cyranka/Burgers/>`_
-  *Efficient and generic algorithm for rigorous integration forward in
   time of dPDEs: Part I* `link
   <http://ww2.ii.uj.edu.pl/~cyranka/FFT/>`_
